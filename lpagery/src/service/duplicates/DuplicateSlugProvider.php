...
class DuplicateSlugProvider
{
    ...
    {
        if(!$data) {
            return  [ "all_slugs_are_the_same" => true, "duplicates" => [], "existing_slugs" => [], "numeric_slugs" => [], "title_contains_placeholder" => false, "attachment_slug_equals" => []];
        }
        if (is_string($data)) {
        ...
        if(!$title_contains_placeholder || $all_slugs_are_the_same) {
            return  ["all_slugs_are_the_same" => $all_slugs_are_the_same, "duplicates" => [], "existing_slugs" => [], "numeric_slugs" => [], "title_contains_placeholder" => $title_contains_placeholder,  "attachment_slug_equals" => []];
        }
        ...
        return [ "all_slugs_are_the_same" => $all_slugs_are_the_same, "duplicates" => $duplicates, "existing_slugs" => $existing_slugs, "numeric_slugs" => $numeric_slugs, "title_contains_placeholder" => $title_contains_placeholder, "attachment_slug_equals" => $attachment_slug_equals];
    }
